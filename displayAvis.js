function displayAvis() {
    ...
    console.log("avisEltsffff", avisClients)

    avisClients.forEach(avisClient => {
        avisClient.addEventListener("click", async function(event) {
            console.log("avisEltsffff", avisClient)
        })
